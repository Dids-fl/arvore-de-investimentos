...
# Quantos meses manter no histórico
MESES_HISTORICO = 36
...
def _localizar_csv(
    ...
    logger.warning(
        ...
        "Utilizando o primeiro disponível."
    )
...
def download_informe_diario(
    ...
    if force or _precisa_atualizar(
        ...
        logger.info(
            "Informe Diário já está atualizado."
        )
...
def _meses_historico(
    quantidade=MESES_HISTORICO,
):
    """
    Retorna uma lista dos últimos 'quantidade'
    meses, incluindo o mês atual.
...
def _remover_antigos(
    ...
    """
    Remove ZIPs e CSVs que não fazem mais
    parte da janela de histórico.
    """
...
def download_historico(
    ...
    """
    Mantém uma janela móvel dos últimos
    'anos' anos de Informe Diário.
    ...
    for ano, mes in meses:
        ...
        try:
            ...
            # O mês atual pode receber correções da CVM
            if (
                ano == hoje.year
                and
                mes == hoje.month
            ...
            # Meses antigos só precisam existir.
